        ...
        // [System.Web.Script.Services.ScriptService]
            ...
            public int NuevoLibro(string nombre, String categoria, String descripcion,String URL,String user_id)
            {
               SqlConnection con =
                ...
                string sql = "INSERT INTO LIBOS (Nombre,Categoria,Descripcion,URL,user_id) VALUES (@nombre, @categoria,@descripcion,@URL,@user_id)";
            ...
            public String[] ListadoClientes()
            {
                ...
                con.Open();
                string sql = "SELECT Nombre, Categoria, Descripcion,URL,user_id FROM LIBOS";
